      ...
      {user && user._id && user._id.length > 0 && user.subscribedBefore ? (
        <div className="text-lg">
          ...
          <button
            ...
            className="disabled:opacity-75 flex mt-2 w-full items-center justify-center rounded-md border border-transparent bg-red-600 py-3 px-8 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
          >
