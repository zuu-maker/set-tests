  ...
  return (
    <div className="w-full">
      <div className="isolate w-full bg-white">
        <div className="absolute  inset-x-0 top-[5rem] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[3rem]">
          <svg
          ...
          >
            ...
            <defs>
              ...
              >
                <stop stopColor="#187da0" />
                <stop offset={1} stopColor="#187da0" />
              </linearGradient>
            </defs>
          </svg>
        </div>
          ...
          <div className="relative px-6 lg:px-8">
            <div className="mx-auto max-w-3xl pt-20 pb-32 sm:pt-48 sm:pb-40">
              <div>
                ...
                <div className="absolute inset-x-0 top-[calc(100%-18rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]">
                  <svg
